...
If you want to consume it directly from the repository folder, run your scripts from inside this directory and import from `__init__`.
...
```python
from __init__ import WebDriver, goto
...
```python
from __init__ import WebDriver
...
```python
from __init__ import WebDriver, generate_ip, use_spoof
...
```python
from __init__ import WebDriver, clear_browser
